...
How It Works
    ...
    The script reads Spotify track URLs from urls.txt.
    It uses Spotify's public oEmbed API to get the exact song name and artist.
    It authenticates with YouTube Music using a secure, local browser session.
    It searches YouTube Music for the exact match.
    It creates a private YouTube Music playlist and adds all the songs.
    It prints a direct link to your new playlist.

Prerequisites

    Python 3.8+ installed on your computer.
    Google Chrome installed on your computer (required for the automated login script).
...
Setup Instructions
    ...
    Authenticate YouTube Music (One-time setup):
